                ...
                return [
                    {
                        ...
                        task: async (ctx, task) => {
                            ...
                            const { compositionValidationResult, checkSchemaResult } = await project.engine.checkPartialSchema(Object.assign(Object.assign({ id: graphID, graphVariant: graphVariant, implementingServiceName: serviceName, partialSchema: {
                                    sdl
                                } }, (historicParameters && { historicParameters })), { gitContext: await git_1.gitInfo(this.log) }));
                    ...
                    },
                    {
                        ...
                        task: async (ctx, task) => {
                            ...
                            const variables = Object.assign(Object.assign({ id: graphID, tag: config.variant, gitContext: await git_1.gitInfo(this.log) }, (historicParameters && { historicParameters })), schemaCheckSchemaVariables);
